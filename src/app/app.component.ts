...
// Si tienes componentes compartidos como Header, también los importas aquí:


@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, CommonModule, HttpClientModule,HeaderComponent, RouterModule],
  template: `
...
export class AppComponent {
  title = 'sistema-reservas-frontend';
